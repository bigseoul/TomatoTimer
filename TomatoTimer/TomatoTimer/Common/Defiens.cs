...
namespace TomatoTimer
{
    public class Defines
    {
        ...
        /// </summary>
        public static readonly string LOCALREPOSITORY_PATH = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\TomatoTimer";

        /// <summary>
        /// Local Repository Filename
        /// </summary>
        public const string LOCALREPOSITORY_FILENAME = "TomatoTimer_repository.data";
